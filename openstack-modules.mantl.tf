...
variable public_key {
  default = "/home/cloud-user/.ssh/id_rsa.pub"
}
...
variable name {
  default = "mantl"
} # resources will start with "mantl-"

variable control_count {
  default = "3"
} # mesos masters, zk leaders, consul servers
...
} # comma separated list of ips, e.g. "8.8.8.8,8.8.4.4"
...
##variable kubeworker_flavor_name {
##  default = "CO3-XLarge"
##}
